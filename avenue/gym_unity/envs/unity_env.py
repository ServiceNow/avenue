...
class UnityEnv(gym.Env):
    ...
    def __init__(self, environment_filename: str, worker_id=0, use_visual=False, multiagent=False, config=None):
        """
        ...
        if brain.vector_action_space_type == "discrete":
            ...
            self._action_space = spaces.Box(-high, high)
        ...
        if self.use_visual:
            if brain.camera_resolutions[0]["blackAndWhite"]:
                ...
                depth = 3
            self._observation_space = spaces.Box(0, 1,
